...
/**
 * BaseAdKeyWordStatsServiceService.as
...
package com.macys.marketing.sema{
	 ...
	 */ 
	public class BaseAdKeyWordStatsService extends AbstractWebService
    {
		private var results:Object;
		private var schemaMgr:SchemaManager;
		private var BaseAdKeyWordStatsServiceService:WSDLService;
		private var BaseAdKeyWordStatsServicePortType:WSDLPortType;
		private var BaseAdKeyWordStatsServiceBinding:WSDLBinding;
		private var BaseAdKeyWordStatsServicePort:WSDLPort;
		private var currentOperation:WSDLOperation;
		private var internal_schema:BaseAdKeyWordStatsServiceSchema;
		 ...
		 */
		public function BaseAdKeyWordStatsService(destination:String=null, rootURL:String=null)
		{
			...
			internal_schema = new BaseAdKeyWordStatsServiceSchema();
...
BaseAdKeyWordStatsServiceService = new WSDLService("BaseAdKeyWordStatsServiceService");
			BaseAdKeyWordStatsServicePort = new WSDLPort("BaseAdKeyWordStatsServicePort",BaseAdKeyWordStatsServiceService);
        	BaseAdKeyWordStatsServiceBinding = new WSDLBinding("BaseAdKeyWordStatsServiceBinding");
	        BaseAdKeyWordStatsServicePortType = new WSDLPortType("BaseAdKeyWordStatsServicePortType");
       		BaseAdKeyWordStatsServiceBinding.portType = BaseAdKeyWordStatsServicePortType;
       		BaseAdKeyWordStatsServicePort.binding = BaseAdKeyWordStatsServiceBinding;
       		BaseAdKeyWordStatsServiceService.addPort(BaseAdKeyWordStatsServicePort);
       		BaseAdKeyWordStatsServicePort.endpointURI = "http://192.168.1.27:8081/SEMAServices/services/v1/AdKeyWordStatsService";
       		if(this.endpointURI == null)
       		{
       			this.endpointURI = BaseAdKeyWordStatsServicePort.endpointURI; 
       		} 
       		
			var requestMessage:WSDLMessage;
	        var responseMessage:WSDLMessage;
//define the WSDLOperation: new WSDLOperation(methodName)
            var getAdKeyWordStats:WSDLOperation = new WSDLOperation("getAdKeyWordStats");
				//input message for the operation
    	        requestMessage = new WSDLMessage("getAdKeyWordStats");
            				requestMessage.addPart(new WSDLMessagePart(new QName("http://schemas.macys.com/api/ad/v1","getAdKeyWordStats"),null,new QName("http://schemas.macys.com/api/ad/v1","getAdKeyWordStats")));
			...
			requestMessage.encoding.useStyle="literal";
	            ...
	            requestMessage.wrappedQName = new QName("http://schemas.macys.com/api/ad/v1","getAdKeyWordStats");
                
                responseMessage = new WSDLMessage("getAdKeyWordStatsResponse");
            				responseMessage.addPart(new WSDLMessagePart(new QName("http://schemas.macys.com/api/ad/v1","getAdKeyWordStatsResponse"),null,new QName("http://schemas.macys.com/api/ad/v1","getAdKeyWordStatsResponse")));
	            ...
	            responseMessage.wrappedQName = new QName("http://schemas.macys.com/api/ad/v1","getAdKeyWordStats");getAdKeyWordStats.inputMessage = requestMessage;
	        getAdKeyWordStats.outputMessage = responseMessage;
            getAdKeyWordStats.schemaManager = this.schemaMgr;
            getAdKeyWordStats.soapAction = "\"\"";
            getAdKeyWordStats.style = "document";
            BaseAdKeyWordStatsServiceService.getPort("BaseAdKeyWordStatsServicePort").binding.portType.addOperation(getAdKeyWordStats);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://schemas.macys.com/api/ad/v1","getAdKeyWordStats"),com.macys.marketing.sema.GetAdKeyWordStats);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://schemas.macys.com/api/ad/v1","AdKeyWordStats"),com.macys.marketing.sema.AdKeyWordStats);
							...
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://schemas.macys.com/api/ad/v1","adKeyWordStatsPK"),com.macys.marketing.sema.AdKeyWordStatsPK);
							...
							SchemaTypeRegistry.getInstance().registerCollectionClass(new QName("http://schemas.macys.com/api/ad/v1","getAdKeyWordStatsResponse"),com.macys.marketing.sema.GetAdKeyWordStatsResponse);}
		/**
		...
		public function getAdKeyWordStats(getAdKeyWordStats:GetAdKeyWordStats):AsyncToken
		{
            ...
            out["getAdKeyWordStats"] = getAdKeyWordStats;
	            currentOperation = BaseAdKeyWordStatsServiceService.getPort("BaseAdKeyWordStatsServicePort").binding.portType.getOperation("getAdKeyWordStats");
