...
/**
 * BaseAdCopyStatsServiceService.as
...
package com.macys.marketing.sema{
	 ...
	 */ 
	public class BaseAdCopyStatsService extends AbstractWebService
    {
		private var results:Object;
		private var schemaMgr:SchemaManager;
		private var BaseAdCopyStatsServiceService:WSDLService;
		private var BaseAdCopyStatsServicePortType:WSDLPortType;
		private var BaseAdCopyStatsServiceBinding:WSDLBinding;
		private var BaseAdCopyStatsServicePort:WSDLPort;
		private var currentOperation:WSDLOperation;
		private var internal_schema:BaseAdCopyStatsServiceSchema;
		 ...
		 */
		public function BaseAdCopyStatsService(destination:String=null, rootURL:String=null)
		{
			...
			internal_schema = new BaseAdCopyStatsServiceSchema();
...
BaseAdCopyStatsServiceService = new WSDLService("BaseAdCopyStatsServiceService");
			BaseAdCopyStatsServicePort = new WSDLPort("BaseAdCopyStatsServicePort",BaseAdCopyStatsServiceService);
        	BaseAdCopyStatsServiceBinding = new WSDLBinding("BaseAdCopyStatsServiceBinding");
	        BaseAdCopyStatsServicePortType = new WSDLPortType("BaseAdCopyStatsServicePortType");
       		BaseAdCopyStatsServiceBinding.portType = BaseAdCopyStatsServicePortType;
       		BaseAdCopyStatsServicePort.binding = BaseAdCopyStatsServiceBinding;
       		BaseAdCopyStatsServiceService.addPort(BaseAdCopyStatsServicePort);
       		BaseAdCopyStatsServicePort.endpointURI = "http://192.168.1.27:8081/SEMAServices/services/v1/AdCopyStatsService";
       		if(this.endpointURI == null)
       		{
       			this.endpointURI = BaseAdCopyStatsServicePort.endpointURI; 
       		} 
       		
			var requestMessage:WSDLMessage;
	        var responseMessage:WSDLMessage;
//define the WSDLOperation: new WSDLOperation(methodName)
            var getAdCopyStats:WSDLOperation = new WSDLOperation("getAdCopyStats");
				//input message for the operation
    	        requestMessage = new WSDLMessage("getAdCopyStats");
            				requestMessage.addPart(new WSDLMessagePart(new QName("http://schemas.macys.com/api/ad/v1","getAdCopyStats"),null,new QName("http://schemas.macys.com/api/ad/v1","getAdCopyStats")));
			...
			requestMessage.encoding.useStyle="literal";
	            ...
	            requestMessage.wrappedQName = new QName("http://schemas.macys.com/api/ad/v1","getAdCopyStats");
                
                responseMessage = new WSDLMessage("getAdCopyStatsResponse");
            				responseMessage.addPart(new WSDLMessagePart(new QName("http://schemas.macys.com/api/ad/v1","getAdCopyStatsResponse"),null,new QName("http://schemas.macys.com/api/ad/v1","getAdCopyStatsResponse")));
	            ...
	            responseMessage.wrappedQName = new QName("http://schemas.macys.com/api/ad/v1","getAdCopyStats");getAdCopyStats.inputMessage = requestMessage;
	        getAdCopyStats.outputMessage = responseMessage;
            getAdCopyStats.schemaManager = this.schemaMgr;
            getAdCopyStats.soapAction = "\"\"";
            getAdCopyStats.style = "document";
            BaseAdCopyStatsServiceService.getPort("BaseAdCopyStatsServicePort").binding.portType.addOperation(getAdCopyStats);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://schemas.macys.com/api/ad/v1","getAdCopyStats"),com.macys.marketing.sema.GetAdCopyStats);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://schemas.macys.com/api/ad/v1","AdCopyStats"),com.macys.marketing.sema.AdCopyStats);
							SchemaTypeRegistry.getInstance().registerClass(new QName("http://schemas.macys.com/api/ad/v1","adCopyStatsPK"),com.macys.marketing.sema.AdCopyStatsPK);
							...
							SchemaTypeRegistry.getInstance().registerCollectionClass(new QName("http://schemas.macys.com/api/ad/v1","getAdCopyStatsResponse"),com.macys.marketing.sema.GetAdCopyStatsResponse);
		...
		public function getAdCopyStats(getAdCopyStats:GetAdCopyStats):AsyncToken
		{
            ...
            out["getAdCopyStats"] = getAdCopyStats;
	            currentOperation = BaseAdCopyStatsServiceService.getPort("BaseAdCopyStatsServicePort").binding.portType.getOperation("getAdCopyStats");
