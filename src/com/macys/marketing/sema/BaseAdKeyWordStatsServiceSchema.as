package com.macys.marketing.sema
{
	 ...
	 public class BaseAdKeyWordStatsServiceSchema
	{
		 public var schemas:Array = new Array();
		 public var targetNamespaces:Array = new Array();
		 public function BaseAdKeyWordStatsServiceSchema():void
{		
    ...
    <xsd:import namespace="https://adwords.google.com/api/adwords/v11" schemaLocation="http://192.168.1.27:8081/SEMAServices/services/v1/AdKeyWordStatsService?xsd=1"/>
</xsd:schema>
;
    ...
    <xs:import namespace="http://schemas.macys.com/api/ad/v1" schemaLocation="http://192.168.1.27:8081/SEMAServices/services/v1/AdKeyWordStatsService?xsd=3"/>
...
;
    ...
    <xs:import namespace="http://schemas.macys.com/definitions/ad/v1" schemaLocation="http://192.168.1.27:8081/SEMAServices/services/v1/AdKeyWordStatsService?xsd=2"/>
    <xs:element name="getAdKeyWordStats" type="tns:getAdKeyWordStats"/>
    <xs:element name="getAdKeyWordStatsResponse" type="tns:getAdKeyWordStatsResponse"/>
    <xs:complexType name="getAdKeyWordStats">
        <xs:sequence>
            <xs:element minOccurs="0" ref="ns1:AdKeyWordIds"/>
            <xs:element minOccurs="0" ref="ns1:Type"/>
        </xs:sequence>
    </xs:complexType>
    <xs:complexType name="getAdKeyWordStatsResponse">
        <xs:sequence>
            <xs:element maxOccurs="unbounded" minOccurs="0" name="return" type="tns:AdKeyWordStats"/>
        </xs:sequence>
    </xs:complexType>
    <xs:complexType name="AdKeyWordStats">
        <xs:sequence>
            <xs:element minOccurs="0" name="AdKeyWordStats" type="tns:adKeyWordStatsPK"/>
    ...
    <xs:complexType name="adKeyWordStatsPK">
        <xs:sequence>
...
;
    ...
    <xs:import namespace="http://schemas.macys.com/api/ad/v1" schemaLocation="http://192.168.1.27:8081/SEMAServices/services/v1/AdKeyWordStatsService?xsd=3"/>
    <xs:element name="AdKeyWordIds" type="xs:string"/>
    <xs:element name="ExceptionInfo" type="ns1:exceptionInfo"/>
    <xs:element name="Type" type="ns1:SemaStatsType"/>
    <xs:element name="adKeyWordStatsBean" type="ns1:AdKeyWordStats"/>
</xs:schema>
;
